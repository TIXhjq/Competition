...
class BaseModel:
    ...
    def readData(self, path='./data/'):
        ...
        train = pd.merge(train_sales, train_search, on=['province', 'adcode', 'model', 'regYear', 'regMonth'],
                         how='left')
    ...
    def lgb_train(self, params,data=None, verbose=500, num_round=20000):
        if data is None:
